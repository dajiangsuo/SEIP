...
from sumo_integration.carla_simulation_opt import CarlaSimulation
...
class SimulationSynchronization(object):
    ...
    def __init__(self,
        ...
        # generate LiDAR at a benchmark place

        
        self.carla.spawn_infra_sensor('lidar', x=-39.408569, y=-20.6965, z=0)
        self.carla.spawn_infra_sensor('lidar', x=-57.408569, y=12.30348, z=0)
        #self.carla.spawn_infra_sensor('lidar', x=-57.408569, y=10.303489, z=0)
        #self.carla.spawn_infra_sensor('lidar', x=-39.408569, y=10.303489, z=0)
        #self.carla.spawn_infra_sensor('lidar', x=tl_0_loc.x, y=tl_0_loc.y, z=0)
        #self.carla.spawn_infra_sensor('lidar', x=tl_1_loc.x, y=tl_1_loc.y, z=0)
        #self.carla.spawn_infra_sensor('lidar', x=tl_2_loc.x, y=tl_2_loc.y, z=0)
        #self.carla.spawn_infra_sensor('lidar', x=tl_3_loc.x, y=tl_3_loc.y, z=0)
    ...
    def tick(self):
        ...
        # carla-->sumo sync
        # -----------------
        self.carla.update_sumo2carla_ids(self.sumo2carla_ids)
        self.carla.tick()
    ...
    def close(self):
        ...
        # Destroying infrastructure added to the carla simulation
        # code to be added!!!
        self.carla.destroy_infra_sensors()
        self.carla.destroy_visualizer()
...
def synchronization_loop(args):
    ...
    carla_simulation = CarlaSimulation(args.carla_host, args.carla_port, args.step_length, args.path_name)

    synchronization = SimulationSynchronization(sumo_simulation, carla_simulation, args.tls_manager,
                                                args.sync_vehicle_color, args.sync_vehicle_lights)

    # spawn infrastructure sensor at a particular locations
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--path_name', type=str, required=True, help='directory for storing data')
