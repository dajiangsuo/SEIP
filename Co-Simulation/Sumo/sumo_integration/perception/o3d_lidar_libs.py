...
#import CARLA_0913.Co-Simulation.Sumo.sumo_integration.perception.sensor_transformation as st
...
from .sensor_transformation import sensor_to_world
from .obstacle_vehicle import \
    is_vehicle_cococlass, ObstacleVehicle
...
def o3d_camera_lidar_fusion(objects,
    ...
    for i in range(yolo_bbx.shape[0]):
        ...
        corner = sensor_to_world(corner, lidar_sensor.get_transform())
